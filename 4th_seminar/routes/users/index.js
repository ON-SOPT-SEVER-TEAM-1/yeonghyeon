...
router.put('/:id', async(req, res) => {
    ...
    try{
        ...
        res.status(statusCode.INTERNAL_SERVER_ERROR).send(statusCode.INTERNAL_SERVER_ERROR, responseMessage.MEMBER_UPDATE_FAIL);
    }
});
...
router.delete('/:id', async(req, res) => {
    ...
    try {
        ...
        res.status(statusCode.INTERNAL_SERVER_ERROR).send(util.fail(statusCode.INTERNAL_SERVER_ERROR, responseMessage.MEMBER_DELETE_FAIL));
    }
});
